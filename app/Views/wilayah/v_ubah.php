    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-10">
                    <div class="form-group">
                        ...
                        <input name="nama_wilayah" value="<?= $wilayah['nama_wilayah'] ?>" class="form-control" required>
                ...
                <div class="col-sm-2">
                    ...
                    <div class="form-group">
                        ...
                        <input name="warna" value="<?= $wilayah['warna'] ?>" class="form-control my-colorpicker1" placeholder="Format HEX..." required>
            ...
            <div class="form-group">
                ...
                <textarea name="geojson" class="form-control" rows="6" required><?= $wilayah['geojson'] ?></textarea>
